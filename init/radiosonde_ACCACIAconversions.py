...
def LEM_LoadTHREF(data, sondenumber):
    ...
    # znref_read(1)=4.6,thref_read(1)=262.67,
    #     znref_read(2)=8.9,thref_read(2)=262.68,
    #     znref_read(3)=13.1,thref_read(3)=262.70,
    #     znref_read(4)=17.4,thref_read(4)=262.72,
    #     znref_read(5)=21.7,thref_read(5)=262.74,
    #     znref_read(6)=26.1,thref_read(6)=262.77,
    #     znref_read(7)=30.4,thref_read(7)=262.80,
    #     znref_read(8)=34.8,thref_read(8)=262.81,
    #     znref_read(9)=39.1,thref_read(9)=262.81,
    #     znref_read(10)=43.5,thref_read(10)=262.79,
    #     znref_read(11)=47.8,thref_read(11)=262.76,
    #     znref_read(12)=52.2,thref_read(12)=262.72,
    #     znref_read(13)=56.4,thref_read(13)=262.66,
    #     znref_read(14)=60.5,thref_read(14)=262.60,
    #     znref_read(15)=64.5,thref_read(15)=262.54,
    #     znref_read(16)=68.6,thref_read(16)=262.48,
    #     znref_read(17)=72.9,thref_read(17)=262.45,
    #     znref_read(18)=77.2,thref_read(18)=262.44,
    #     znref_read(19)=81.5,thref_read(19)=262.45,
    #     znref_read(20)=85.6,thref_read(20)=262.47,
    #     znref_read(21)=89.7,thref_read(21)=262.51,
    #     znref_read(22)=93.8,thref_read(22)=262.54,
    #     znref_read(23)=97.9,thref_read(23)=262.56,
    #     znref_read(24)=102.1,thref_read(24)=262.57,
    #     znref_read(25)=106.3,thref_read(25)=262.58,
    #     znref_read(26)=114.3,thref_read(26)=262.61,
    #     znref_read(27)=118.1,thref_read(27)=262.65,
    #     znref_read(28)=121.8,thref_read(28)=262.70,
    #     znref_read(29)=125.4,thref_read(29)=262.75,
    #     znref_read(30)=129.0,thref_read(30)=262.78,
    #     znref_read(31)=132.6,thref_read(31)=262.79,
    #     znref_read(32)=136.3,thref_read(32)=262.75,
    #     znref_read(33)=140.1,thref_read(33)=262.69,
    #     znref_read(34)=144.1,thref_read(34)=262.62,
    #     znref_read(35)=148.3,thref_read(35)=262.57,
    #     znref_read(36)=152.5,thref_read(36)=262.54,
    #     znref_read(37)=156.9,thref_read(37)=262.53,
    #     znref_read(38)=161.3,thref_read(38)=262.54,
    #     znref_read(39)=165.7,thref_read(39)=262.54,
    #     znref_read(40)=170.1,thref_read(40)=262.53,
    #     znref_read(41)=174.5,thref_read(41)=262.50,
    #     znref_read(42)=179.0,thref_read(42)=262.47,
    #     znref_read(43)=183.7,thref_read(43)=262.42,
    #     znref_read(44)=188.5,thref_read(44)=262.38,
    #     znref_read(45)=193.5,thref_read(45)=262.35,
    #     znref_read(46)=198.7,thref_read(46)=262.32,
    #     znref_read(47)=204.0,thref_read(47)=262.31,
    #     znref_read(48)=209.3,thref_read(48)=262.31,
    #     znref_read(49)=214.6,thref_read(49)=262.32,
    #     znref_read(50)=220.1,thref_read(50)=262.33,
